                    ...
                    <table>
                      <tr>
                        <td>
                          <h5 style="font-weight: 700;font-size: 20px;line-height: 150%;">
                            Bienvenido a mi Tienda Ecommerce
                          </h5>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                            Gracias por registrarte en la tienda, sientete libre de ver los productos y precios que ofrecemos.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                          <p>Atentamente, <br />Equipo Ecommerce</p>
                          </p>
                        </td>
                      </tr>
                      <tr>
                          ...
                          <table style="width:100%">
                            <tr>
                              <td
                                ...
                                <a href="#"
                                  style="text-decoration: none;color:#ffffff;font-weight: 600;font-size: 18px;">Ir la tienda</a>
                              </td>
                              <td style="width:30%;">
                              </td>
                            </tr>
